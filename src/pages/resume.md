...
- Developed the customer education resources and onboarding journey for our generative AI offering, Bluescape AI (pivoted into Wowzer AI)
- Led post-sales deployment, training, adoption, renewal, expansion, and feedback cycles for my BoB
- QA'd features pre-release to catch usability concerns & bugs
...
Certified Associate Project Manager (**[CAPM](https://www.pmi.org/certifications/certified-associate-capm)**), **[Brainstation](https://brainstation.io/)** Product Management Certification, **[Designlab](https://designlab.com/)** UX Academy Foundations, **Notion Essentials** Certification, **[Pre-Script L1](https://www.pre-script.com/)** (Personal Training), Functional Patterns
